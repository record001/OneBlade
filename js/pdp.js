...
let cream_item_arr = document.querySelectorAll(".cream-item");
...
cream_item_arr.forEach((item, index) => {

  // if (!item.classList.contains("cream-item--border")) {
    item.addEventListener("click", (e) => {

      document.querySelector(".cream-grid .cream-item--border").classList.remove("cream-item--border")
          e.target.classList.add("cream-item--border");
